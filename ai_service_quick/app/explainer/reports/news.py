...
class _EvidenceExplainer:
    ...
    def explain(self, report: KeywordHighlightingReport) -> str:
        ...
        return self._TEMPLATE.format(positive_str=positive_str, negative_str=negative_str)
...
class _SingleNewsExplainer:
    ...
    def explain(self, report: SingleNewsAnalysisReport) -> str:
        ...
        impact_exp = self.impact_explainer.explain(report.impact_assessment) if report.impact_assessment else ""
        ner_exp = self.ner_explainer.explain(report.ner) if report.ner else ""
        evidence_exp = self.evidence_explainer.explain(report.keyword_highlighting_evidence) if report.keyword_highlighting_evidence else ""
