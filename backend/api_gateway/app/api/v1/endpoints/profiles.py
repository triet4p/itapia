...
from itapia_common.schemas.api.profiles import (
...
from itapia_common.schemas.entities.users import (
    UserEntity,
)  # Assuming UserEntity is defined here
...
def get_user_profiles(
    ...
    return [_change_from_entity_to_response(profile) for profile in profiles]
