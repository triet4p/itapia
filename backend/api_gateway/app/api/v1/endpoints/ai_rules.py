...
from app.clients.ai_rules import get_nodes, get_ready_rules, get_single_rule_explain
...
async def get_ai_nodes(
    node_type: NodeType = NodeType.ANY, purpose: SemanticType = SemanticType.ANY
):
