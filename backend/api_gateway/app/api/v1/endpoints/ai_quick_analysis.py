...
@router.get('/analysis/quick/{ticker}/full', 
...
@router.get('/analysis/quick/{ticker}/technical', 
...
@router.get('/analysis/quick/{ticker}/forecasting', 
...
@router.get('/analysis/quick/{ticker}/news', 
...
@router.get('/analysis/quick/{ticker}/explain', 
