...
@router.get("/market/tickers/{ticker}/prices/daily", 
...
@router.get("/market/sectors/{sector}/prices/daily", 
...
@router.get("/market/tickers/{ticker}/prices/intraday", 
            response_model=PriceResponse, 
            tags=['Market Prices'],
...
@router.get("/market/tickers/{ticker}/news", 
...
@router.get("/market/news/universal", 
