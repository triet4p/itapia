...
def test_get_user_by_google_id_success():
    ...
    with pytest.MonkeyPatch().context() as m:
        m.setattr("app.services.users.get_by_google_id", lambda session, google_id: mock_row)
...
def test_get_user_by_google_id_not_found():
    ...
    with pytest.MonkeyPatch().context() as m:
        m.setattr("app.services.users.get_by_google_id", lambda session, google_id: None)
