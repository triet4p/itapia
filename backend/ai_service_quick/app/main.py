...
from .api.v1.endpoints import backtest, quick_advisor, quick_analysis, root, rules
...
# Include all routers
app.include_router(
    quick_analysis.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["AI Quick Analysis"]
)
app.include_router(
    quick_advisor.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["AI Quick Advisor"]
)
app.include_router(rules.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["AI Rules"])
app.include_router(
    backtest.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["Backtest Generation"]
)
app.include_router(root.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["Root"])
app.include_router(
    personal.router, prefix=AI_QUICK_V1_BASE_ROUTE, tags=["Personalization"]
)
