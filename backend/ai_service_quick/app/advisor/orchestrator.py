...
from itapia_common.schemas.entities.advisor import AdvisorReportSchema, AggregatedScoreInfo, FinalRecommendation, TriggeredRuleInfo
...
class AdvisorOrchestrator:
    ...
    async def get_advisor_report(self, analysis_report: QuickCheckAnalysisReport, 
                                 ...
                                 action_mapper: Optional[_BaseActionMapper] = None) -> AdvisorReportSchema:
    ...
    def _create_final_recommendation_text(self, final_action: Action, triggered_rules: List[TriggeredRuleInfo]) -> str:
        ...
        return (f"Recommendation: {action_text}. "
    ...
    async def get_full_explaination_report(self, analysis_report: QuickCheckAnalysisReport, 
                                 ...
                                 opportunity_results: Tuple[List[float], List[TriggeredRuleInfo]],
                                 behavior_modifiers: Optional[BehaviorModifiers] = None,
                                 action_mapper: Optional[_BaseActionMapper] = None) -> str:
