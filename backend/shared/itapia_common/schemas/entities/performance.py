...
class PerformanceHardConstraints(BaseModel):
    ...
    total_return_pct: Tuple[Optional[float], Optional[float]] = Field(
        default=(None, None)
    )
    max_drawdown_pct: Tuple[Optional[float], Optional[float]] = Field(
        default=(None, None)
    )
    ...
    annual_return_stability: Tuple[Optional[float], Optional[float]] = Field(
        default=(None, None)
    )
...
NORMALIZATION_CONFIG: Dict[str, Dict] = {
    "cagr": {"worst": -0.20, "best": 0.30, "direction": "higher_is_better"},
    "sortino_ratio": {"worst": 0.0, "best": 3.0, "direction": "higher_is_better"},
    "max_drawdown_pct": {
    ...
    "profit_factor": {"worst": 1.0, "best": 3.0, "direction": "higher_is_better"},
    "win_rate_pct": {
        "worst": 0.40,  # 40%
        "best": 0.65,  # 65%
        "direction": "higher_is_better",
    },
    "num_trades": {"worst": 10, "best": 100, "direction": "higher_is_better"},
