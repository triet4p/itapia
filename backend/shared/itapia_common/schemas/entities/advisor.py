...
class FinalRecommendation(BaseModel):
    ...
    triggered_rules: List[TriggeredRuleInfo] = Field(
...
class AdvisorReportSchema(BaseModel):
    ...
    aggregated_scores: AggregatedScoreInfo = Field(
