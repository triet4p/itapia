...
register_node_by_spec(nms.OPR_GT, NodeSpec(
    ...
    return_type=SemanticType.BOOLEAN, args_type=[SemanticType.ANY, SemanticType.ANY], node_type=NodeType.OPERATOR,
...
register_node_by_spec(nms.OPR_AND, NodeSpec(
    ...
    return_type=SemanticType.BOOLEAN, args_type=[SemanticType.BOOLEAN, SemanticType.BOOLEAN], node_type=NodeType.OPERATOR,
...
register_node_by_spec(nms.OPR_NOT, NodeSpec(
    ...
    return_type=SemanticType.BOOLEAN, args_type=[SemanticType.BOOLEAN], node_type=NodeType.OPERATOR,
...
register_node_by_spec(nms.OPR_TO_DECISION_SIGNAL, NodeSpec(
    ...
    return_type=SemanticType.DECISION_SIGNAL, args_type=[SemanticType.ANY], node_type=NodeType.OPERATOR,
...
register_node_by_spec(nms.OPR_TO_RISK_LEVEL, NodeSpec(
    ...
    return_type=SemanticType.RISK_LEVEL, args_type=[SemanticType.ANY], node_type=NodeType.OPERATOR,
...
register_node_by_spec(nms.OPR_TO_OPPORTUNITY_RATING, NodeSpec(
    ...
    return_type=SemanticType.OPPORTUNITY_RATING, args_type=[SemanticType.ANY], node_type=NodeType.OPERATOR,
    params={'num_child': 1, 'opr_func': lambda x: _sigmoid(x)}
))