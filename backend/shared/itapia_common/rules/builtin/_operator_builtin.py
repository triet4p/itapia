...
from itapia_common.rules.nodes import BranchOperatorNode, FunctionalOperatorNode
...
register_node_by_spec(
    ...
    NodeSpec(
        ...
        return_type=SemanticType.ANY_NUMERIC,
        args_type=[SemanticType.ANY_NUMERIC, SemanticType.ANY_NUMERIC],
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Subtracts second value from the first (arg1 - arg2)",
        return_type=SemanticType.ANY_NUMERIC,
        args_type=[SemanticType.ANY_NUMERIC, SemanticType.ANY_NUMERIC],
        node_type=NodeType.OPERATOR,
        params={"num_child": 2, "opr_func": lambda x, y: x - y},
...
register_node_by_spec(
    ...
    NodeSpec(
        ...
        return_type=SemanticType.ANY_NUMERIC,
        args_type=[SemanticType.ANY_NUMERIC, SemanticType.NUMERICAL],
        node_type=NodeType.OPERATOR,
        params={"num_child": 2, "opr_func": lambda x, y: x * y},
    ),
)
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Divides first value by the second (arg1 / arg2). Returns 0 if divisor is 0.",
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Calculates the base-2 logarithm of a value. Returns 0 for non-positive input.",
        return_type=SemanticType.NUMERICAL,
        args_type=[SemanticType.NUMERICAL],
        node_type=NodeType.OPERATOR,
...
register_node_by_spec(
    ...
    NodeSpec(
        ...
        return_type=SemanticType.ANY_NUMERIC,
        args_type=[SemanticType.ANY_NUMERIC],
        node_type=NodeType.OPERATOR,
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Greater Than (>). Returns 1.0 if arg1 > arg2, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Less Than (<). Returns 1.0 if arg1 < arg2, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
        params={"num_child": 2, "opr_func": lambda x, y: 1.0 if x < y else 0.0},
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Greater Than or Equal (>=). Returns 1.0 if arg1 >= arg2, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
        params={"num_child": 2, "opr_func": lambda x, y: 1.0 if x >= y else 0.0},
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Less Than or Equal (<=). Returns 1.0 if arg1 <= arg2, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
        params={"num_child": 2, "opr_func": lambda x, y: 1.0 if x <= y else 0.0},
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Equal (==). Returns 1.0 if values are close, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
        params={
            "num_child": 2,
            "opr_func": lambda x, y: 1.0 if math.isclose(x, y) else 0.0,
        },
    ),
)
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Not Equal (!=). Returns 1.0 if values are not close, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.ANY, SemanticType.ANY],
        node_type=NodeType.OPERATOR,
        params={
            "num_child": 2,
            "opr_func": lambda x, y: 1.0 if not math.isclose(x, y) else 0.0,
        },
    ),
)
...
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Logical AND. Returns 1.0 if all args > 0, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.BOOLEAN, SemanticType.BOOLEAN],
        node_type=NodeType.OPERATOR,
        params={
            "num_child": 2,
            "opr_func": lambda *args: 1.0 if all(arg > 0 for arg in args) else 0.0,
        },
    ),
)
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Logical OR. Returns 1.0 if any arg > 0, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.BOOLEAN, SemanticType.BOOLEAN],
        node_type=NodeType.OPERATOR,
        params={
            "num_child": 2,
            "opr_func": lambda *args: 1.0 if any(arg > 0 for arg in args) else 0.0,
        },
    ),
)
register_node_by_spec(
    ...
    NodeSpec(
        node_class=FunctionalOperatorNode,
        description="Logical NOT. Returns 1.0 if arg <= 0, else 0.0.",
        return_type=SemanticType.BOOLEAN,
        args_type=[SemanticType.BOOLEAN],
        node_type=NodeType.OPERATOR,
