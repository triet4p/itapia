...
from itapia_common.schemas.entities.evo import EvoRuleEntity, EvoRunEntity
...
class EvoService:
    ...
    def get_all_rules(
        self, rule_status: RuleStatus, evo_run_id: str | None = None
    ) -> List[EvoRuleEntity]:
    ...
    def get_evo_run(self, evo_run_id: str) -> EvoRunEntity | None:
        ...
        return EvoRunEntity(rules=rules, **res_dict)
